		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cadeloittehremployeemanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cadeloittehremployeemanagement-display": {
								"semanticObject": "cadeloittehremployeemanagement",
								"action": "display",
								"description": "A Fiori application to manage employees",
								"title": "Employee Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ca.deloitte.hr.employeemanagement",
									"url": sap.ui.require.toUrl("ca/deloitte/hr/employeemanagement")
								}
							}
						}
					}
